...
## G1 Interface
Network setup and instructions for controlling the G1 robot through DDS can be found here:
https://support.unitree.com/home/en/G1_developer

## Cassie Interface
Calibration, development PC, and network setup instructions for controlling the Cassie robot through UDP and Simulink Real-Time Explorer target PC can be found here:
https://github.com/agilityrobotics/cassie-doc/wiki