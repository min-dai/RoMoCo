    ...
    : Node("ros_interface_node"), interface_(interface)
{
  ...
  ctrl_sub_ = create_subscription<romoco_msgs::msg::BipedMotorCommands>(
      "controller_cmds", qos,
      [this](const romoco_msgs::msg::BipedMotorCommands::SharedPtr msg)
      {
        {
  ...
  proprio_pub_ = create_publisher<romoco_msgs::msg::BipedProprioception>("proprioception", qos);
