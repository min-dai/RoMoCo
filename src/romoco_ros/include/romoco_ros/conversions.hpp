...
namespace romoco
{
  ...
  /**
   * @brief Convert Proprioception ROS message to BipedProprioception structure.
  ...
  /**
   * @brief Convert BipedProprioception structure to ROS message.
   * @ingroup group_interface
   */
  ...
  /**
   * @brief Convert ROS message to BipedMotorCommands structure.
   * @ingroup group_interface
   */
  ...
  /**
   * @brief Convert BipedMotorCommands structure to ROS message.
   * @ingroup group_interface
   */
