...
namespace romoco
{
    ...
    * @brief A Kalman filter for estimating the velocity of a biped robot's base using IMU and encoder data.
    * This class implements a discrete-time Kalman filter to fuse acceleration measurements from an IMU
    * and position measurements from joint encoders to estimate the base velocity of a biped robot
    */
   class ContactKf
   {
