...
namespace romoco
{
   namespace robot
   {
      ...
      {
         return {
             {left_footF_, "left_foot_F"}, {left_footB_, "left_foot_B"}, {left_below_ankle_, "left_below_ankle"}, {left_mid_foot_, "left_mid_foot"}, {left_ankle_, "left_ankle"}, {right_footF_, "right_foot_F"}, {right_footB_, "right_foot_B"}, {right_below_ankle_, "right_below_ankle"}, {right_mid_foot_, "right_mid_foot"}, {right_ankle_, "right_ankle"}, {left_hip_, "left_hip"}, {right_hip_, "right_hip"}, {base_, "base"}, {baseF_, "baseF"}, {baseB_, "baseB"}, {baseL_, "baseL"}, {baseR_, "baseR"}};
      }
   } // namespace robot
} // namespace romoco