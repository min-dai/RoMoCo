...
namespace romoco
{
H1MujocoInterface::H1MujocoInterface(const std::string &config_folder, const std::string &log_path)
{
   Init(config_folder, log_path);
}
H1MujocoInterface::H1MujocoInterface(const std::string &config_folder, const std::string &log_path, std::unique_ptr<romoco::robot::RobotBasePinocchio> robot)
    : robot_(std::move(robot)),
      contact_kf_(std::make_unique<ContactKf>(config_folder, 6))
{
   Init(config_folder, log_path);
}
H1MujocoInterface::~H1MujocoInterface()
{
   std::cout << "H1 Mujoco interface destructor called." << std::endl;
}

void H1MujocoInterface::Init(const std::string &config_folder, const std::string &log_path)
{
...
bool H1MujocoInterface::Step(const Eigen::VectorXd &leg_control_input, const Eigen::VectorXd &upper_control_input)
{
...
void H1MujocoInterface::UpdateMujocoTrueSensorData()
{
...
void H1MujocoInterface::UpdateHardwareSensorData()
{
...
void H1MujocoInterface::Estimate()
{
...
BipedProprioception H1MujocoInterface::ReadAndEstimate()
{
   if (robot_ != nullptr)
   {
      Estimate();
...
void H1MujocoInterface::SendPacket()
{
...
void H1MujocoInterface::HandleRendering()
{
