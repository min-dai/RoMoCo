...
{
    /**
     * @brief Output structure for contact classification.
     */
    ...
    /**
     * @brief Input structure for contact classification.
     */
    ...
    /**
     * @brief Class for contact classification.
     * @ingroup group_utils
     * @details This class implements a contact classifier that estimates the probability of contact for left and right feet based on joint torques and Jacobians.
     * It uses a low-pass filter to smooth the contact probabilities over time.
     * The classifier parameters can be configured via a YAML file.
     */
